...
const SocialPulseView: React.FC<{ onBack: () => void }> = ({ onBack }) => (
  ...
  >
    ...
    {/* Sidebar Navigation - Replace "Event Trends" item */}
    <div className="fixed top-1/2 left-0 transform -translate-y-1/2 bg-white rounded-xl shadow-lg p-4 w-64">
      <h2 className="text-lg font-bold mb-4 text-blue-900">Dashboard</h2>
      <ul className="space-y-2">
        <li>
          <Link
            to="/social-pulse"
            className="flex items-center gap-2 px-4 py-2 rounded bg-white text-blue-900 font-semibold hover:bg-blue-100 transition"
          >
